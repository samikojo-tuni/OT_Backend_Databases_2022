...
Kirjoita tallennettu proseduuri, joka lisää kommentin blogin postaukselle. Proseduurissa tulee olla määritettynä
virheenhallinta. Kommentti voidaan lisätä, jos kommentoitava postaus on olemassa ja kommentin on kirjoittanut käyttäjä,
